OC.L10N.register(
    ...
    "Please double check the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%1$s\">installation guides ↗</a>, and check for any errors or warnings in the <a href=\"%2$s\">log</a>." : "請仔細確認<a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%1$s\">安装指南↗</a>，並檢查<a href=\"%2$s\">紀錄檔</a>中是否有錯誤或警告。",
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "透過<a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">此安全掃描 ↗</a>檢查您的 Nextcloud 安全性",
    "Version" : "版本",
    ...
    "Share" : "分享",
    "Welcome mail sent!" : "已發送成功！",
    "Last login" : "最近一次登入",
    "Show storage path" : "顯示儲存位址",
    "Show Languages" : "顯示使用語言",
    "Default quota:" : "預設磁碟配額：",
    "Remove group" : "刪除群組",
    "Resend welcome email" : "重送歡迎郵件",
    "Delete user" : "刪除使用者",
    "Disable user" : "關閉使用者",
    "When groups are selected/excluded, they use the following logic to determine if a user has 2FA enforced: If no groups are selected, 2FA is enabled for everyone except members of the excluded groups. If groups are selected, 2FA is enabled for all members of these. If a user is both in a selected and excluded group, the selected takes precedence and 2FA is enforced." : "選擇/排除群組時，它們使用以下邏輯來確定使用者是否強制執行了 2FA(雙因子認證)：如果未選擇強制啟用任何群組，則除了列在排除群組成員以外的所有人都會啟用 2FA。如果群組已被選擇強制啟用，則這些群組的所有成員都會啟用 2FA。如果使用者同時存在於啟用及排除的群組中，則以啟用的群組為優先，並強制執行 2FA。",
    "Two-factor authentication is not enforced for\tmembers of the following groups." : "不對以下群組的成員強制啟用雙因子認證機制。",
    "Two-factor authentication is enforced for all\tmembers of the following groups." : "對以下群組的成員強制啟用雙因子認證機制。",
    "Enforcement of two-factor authentication can be set for certain groups only." : "強制只為特定群組設定雙因子認證機制。",
    "Excluded groups" : "強制排除的群組",
    "Enforced groups" : "強制啟用的群組",
    "Enforce two-factor authentication" : "強制啟用雙因子認證",
    "Two-factor authentication can be enforced for all\tusers and specific groups. If they do not have a two-factor provider configured, they will be unable to log into the system." : "雙因子認證可針對所有使用者或是特定群組啟用。如果沒有設定雙因子認證方式，使用者將無法登錄系統。",
    "An error occured during the request. Unable to proceed." : "過程發生錯誤，中止設定工作。",
    "No users in here" : "目前沒有使用者",
    "Add user in group" : "設定群組為(可複選)",
    "Set user as admin for" : "設定使用者為群組管理員",
    "New user" : "新增使用者",
    "Please confirm the group removal " : "請確認刪除群組",
    "You are about to remove the group {group}. The users will NOT be deleted." : "您正在刪除【{group}】群組。該群組中的使用者將不會被刪除。",
    "You are a member of the following groups:" : "您是以下群組的成員：",
    "You are using <strong>%s</strong>" : "您已經使用 <strong>%s</strong>"
},
"nplurals=1; plural=0;");
