...
class MailService {
	...
	public function sendTokenByMail(Registration $registration) {
		...
		$html_template = new TemplateResponse('ndcregistration', 'email.validate_html', $template_var, 'blank');
		$html_part = $html_template->render();
		$plaintext_template = new TemplateResponse('ndcregistration', 'email.validate_plaintext', $template_var, 'blank');
