OC.L10N.register(
    ...
    "config console" : "管理後台",
    "Collabora Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "ODF文件WEB應用元件 是一款基於 LibreOffice Online 並具有共同編輯能力的線上辦公室套件，它支援所有主流的文件、試算表及簡報檔應用及標準的 ODF 格式，可在所有現代瀏覽器使用。",
    "Collabora Online server is reachable." : "ODF文件WEB應用元件 伺服器可以連接",
    "Could not establish connection to the Collabora Online server. This might be due to a missing configuration of your web server. For more information, please visit:" : "無法與 ODF文件WEB應用元件 伺服器建立連接。這可能是由於伺服器配置錯誤所致。有關更多信息，請訪問：",
    "Could not establish connection to the Collabora Online server." : "無法與ODF文件WEB應用元件伺服器建立連接",
    "Please configure a Collabora Online server to start editing documents" : "請配置 ODF文件WEB應用元件 伺服器以開始編輯文件",
    "Collabora Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "ODF文件WEB應用元件需要一台單獨的伺服器作為 WOPI 客户端以提供編輯功能。",
    "URL (and Port) of Collabora Online-server" : "ODF文件WEB應用元件伺服器的URL(及服務port號)",
    "Saved with error: Collabora Online should use the same protocol as the server installation." : "儲存時出錯：ODF文件WEB應用元件需使用與伺服器相同的協定。",
    "Apply" : "套用",
    "Enable if your Collabora Online server uses a self signed certificate" : "若您的ODF文件WEB應用元件伺服器使用自行發行的憑證，請啟用",
    "Collabora Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "線上共編的功能預設是開放給所有使用者使用，當此設定生效時，將只有特定的群組成員才能使用此功能。",
    ...
    "Add" : "增加",
    "This link has been expired or is never existed. Please contact the person who shared it with you for details." : "該鏈結已失效或不存在。詳情請聯絡文件擁有者。",
    "User Templates" : "個人範本",
    "Templaterepo" : "範本中心",
    "No Template" : "無範本",
    ...
    "Automatically convert Microsoft Office files to ODF files" : "自動轉換微軟 Office 格式為開放文件格式",
    "Enable automatically convert Microsoft Office files to ODF files" : "啟用自動轉換微軟 Office 格式為開放文件格式",
