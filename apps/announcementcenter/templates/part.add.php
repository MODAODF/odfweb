...
?>
<div id="newAnnounce">
	<label for="toggleForm"><h2>+ <?php p($l->t('Add announcement')); ?></h2></label>
	<input type="checkbox" id="toggleForm" name="toggleForm" value="toggleForm">
	...
	<form id="announce" class="section">
		...
		<input type="button" id="announcement_options_button" class="hidden" value="<?php p($l->t('Advanced options')); ?>" name="options" />
