...
class Delete extends Base {
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		if ($folder) {
			...
			$question = new ConfirmationQuestion('Are you sure you want to delete the template repo' . $folder['mount_point'] . ' and all files within, this can not be undone (y/N).', false);
