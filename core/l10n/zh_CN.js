OC.L10N.register(
    ...
    "Update to the latest version" : "升级到至最新版本",
    ...
    "_The update was successful. Redirecting you to {name} in %n second._::_The update was successful. Redirecting you to {name} in %n seconds._" : ["升级成功，在%n秒内重定向到 {name}"],
    ...
    "%1$s will be updated to the latest version" : "%1$s 将会升级至最新版本",
